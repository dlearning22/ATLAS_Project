...
# -*- coding: utf-8 -*-
"""Copy of R2AU-net.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dvmip3E_th4BNHJcQ-znP3r0J7rTS6VM
...
class UNet3D(nn.Module):
    def __init__(self,
        ...
        planes = [inplanes * int(pow(2, i)) for i in range(0, 6)] # int()= integer, pow()=power, a list is created: [32,64,128,256,512,1024]         
        ...
        self.RRCNN5 = RRCNN_block(planes[4],planes[5],t=t)
        

        self.Up5 = up_conv(planes[5],planes[4])
        self.Att5 = Attention_block(F_g= planes[4],F_l= planes[4],F_int= planes[3])
        self.Up_RRCNN5 = RRCNN_block(planes[5], planes[4],t=t)
